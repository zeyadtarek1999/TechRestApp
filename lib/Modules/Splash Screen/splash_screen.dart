...
class splash_screen extends StatelessWidget {
  final Techstyle = TextStyle(
      fontSize: 40, color: HexColor("#A27CB1"), fontWeight: FontWeight.bold);
  final Reststyle = TextStyle(
      fontSize: 40, color: HexColor("#4A4B4D"), fontWeight: FontWeight.bold);
      ...
      splash: Center(
        child: Column(
          children: [
            ...
            Text(
              'more independence.....more freedom'.toUpperCase(),
