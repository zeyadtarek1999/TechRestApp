  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          elevation: 0,
          title: Text('Select your table',style: TextStyle(fontSize: 20,fontWeight: FontWeight.w400,color: Colors.black),),
        ),
        backgroundColor: Colors.white,
        body: SingleChildScrollView(
            ...
            child: Column(
                ...
                children: [
                  SizedBox(height: 40,),
                  Image(image: AssetImage('images/table 2D.png'), width: double.infinity, fit: BoxFit.cover,),
                  SizedBox(height: 45,),
                  Center(
                    child: Column(
                      children: [
