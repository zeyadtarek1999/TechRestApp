...
// int? Balance = retrievedorderList?[0].price;

class order_select extends StatefulWidget {
  @override
  State<order_select> createState() => _order_selectState();
}

class _order_selectState extends State<order_select> {
  @override
  void initState() {
    super.initState();
    _initRetrieval();
                    ...
                    Padding(
                      ...
                      child: Container(
                          ...
                          child: CircleAvatar(
                              ...
                              child: Padding(
                                padding:
                                const EdgeInsets.only(bottom: 26, left: 7),
                                child: Image.network(
                  ...
                  child: Container(
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          ...
                          style:
                          TextStyle(color: HexColor('#656565'), fontSize: 12),
                        ),
                      )),
                ),
                Padding(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        color: Colors.white),
                    child: Text('${retrievedorderList?[0].price??'loading'} L.E'),
                    alignment: Alignment.center,
                  ),
                )
              ],
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Text(
                                    ...
                                    style: TextStyle(color: HexColor('#FC6011')),
                                  ),
                                  Spacer(),
                            ...
                            Padding(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Text('${retrievedorderList?[0].beefBurger??'loading'} L.E',
                                      style:
                                      TextStyle(color: HexColor('#FC6011'))),
                                  Spacer(),
                                  FloatingActionButton(
                                      backgroundColor: HexColor('#F0997A'),
                                      onPressed: () {
                            ...
                            Padding(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Text('${retrievedorderList?[0].pickles??'loading'} L.E',
                                      style:
                                      TextStyle(color: HexColor('#FC6011'))),
                                  Spacer(),
                                  FloatingActionButton(
                            ...
                            Padding(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Text('${retrievedorderList?[0].cheese??'loading'} L.E',
                                      style:
                                      TextStyle(color: HexColor('#FC6011'))),
                                  Spacer(),
                                  FloatingActionButton(
                            ...
                            Padding(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Text('${retrievedorderList?[0].onion??'loading'} L.E',
                                      style:
                                      TextStyle(color: HexColor('#FC6011'))),
                                  Spacer(),
                                  FloatingActionButton(
                            ...
                            Padding(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Text('${retrievedorderList?[0].tomato??'loading'} L.E',
                                      style:
                                      TextStyle(color: HexColor('#FC6011'))),
                                  Spacer(),
                                  FloatingActionButton(
                            ...
                            Padding(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Text('${retrievedorderList?[0].tastySauce??'loading'} L.E',
                                      style:
                                      TextStyle(color: HexColor('#FC6011'))),
                                  Spacer(),
                                  FloatingActionButton(
                          ...
                          Row(
                            children: [
                              ...
                              FloatingActionButton(
                                  ...
                                  child: Text('-',
                                      style:
                                      TextStyle(color: HexColor('#7A428F'))),
                                  mini: true),
                              SizedBox(
                                width: 6,
                              ),
                              ...
                              FloatingActionButton(
                                ...
                                child: Text('+',
                                    style: TextStyle(color: HexColor('#7A428F'))),
                                mini: true,
                              )
                            ],
                          ),
                    ...
                    children: [
                      ...
                      Container(
                          ...
                          child: MaterialButton(
                            onPressed: () {
                              navigateTo(context, checkout_screen(subTotal: '${balance}',));
                            },
                            child: Row(
                              children: [
                                Spacer(),
